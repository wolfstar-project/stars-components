...
`@wolfstar/http-framework-i18n`), and add `--subcommands` / `--testing` toggles for a
subcommand example command and a vitest + `@wolfstar/http-framework-test-utils` testing setup.

...
| [`@wolfstar/stars-config`](./packages/stars-config)                                 | Typed `stars.config.*` schema and loader shared by `@wolfstar/http-framework` and `@wolfstar/cli`                   | [![version](https://npmx.dev/api/registry/badge/version/@wolfstar/stars-config)](https://npmx.dev/package/@wolfstar/stars-config)                                 |

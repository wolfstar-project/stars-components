...
export { configDiagnostics, loadStarsConfig } from '@wolfstar/http-framework/config';
export type { ConfigDiagnosticCode, ResolvedStarsConfig } from '@wolfstar/http-framework/config';

...
const TwitchRequestHeaders: Headers = {
	...
	'User-Agent': `@wolfstar/twitch-helpers/${version} (NodeJS) ${platform()}/${release()} (https://github.com/wolfstar-project/stars-components/tree/main/packages/twitch-helpers)`
};

/**
 * Public, side-effect free `stars.config.*` schema, shared by `@wolfstar/http-framework` (which re-exports it as
 * `@wolfstar/http-framework/config`) and `@wolfstar/cli` — see the package README for why this lives on its own.
 *
